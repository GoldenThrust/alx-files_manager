...
class FilesController {
    ...
    static async getShow(req, res) {
        ...
        const file = await (await dbClient.getCollection('files')).findOne({ _id: new mongoDBCore.BSON.ObjectId(id), userId })
    ...
    static async getIndex(req, res) {
        ...
        const files = await (await dbClient.getCollection('files')).aggregate(pipeline).toArray();
    ...
    static async putPublish(req, res) {
        ...
        await (await dbClient.getCollection('files')).updateOne(filter, { $set: { isPublic: true } });
    ...
    static async putUnpublish(req, res) {
        ...
        await (await dbClient.getCollection('files')).updateOne(filter, { $set: { isPublic: false } });
    ...
    static async getFile(req, res) {
        ...
        const file = await (await dbClient.getCollection('files')).findOne({ _id: new mongoDBCore.BSON.ObjectId(fileId) });
